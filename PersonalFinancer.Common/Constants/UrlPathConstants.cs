namespace PersonalFinancer.Common.Constants
{
	public static class UrlPathConstants
	{
		...
		public const string ApiAllMessagesEndpoint = "/api/messages/all/";
		public const string ApiArchivedMessagesEndpoint = "/api/messages/archived/";

		public const string TransactionDetailsPath = "/Transactions/Details/";
		public const string TransactionEditPath = "/Transactions/Edit/";
